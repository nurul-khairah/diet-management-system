...
<div class="container">
   <div class="row" style="margin-top:45px">
      <div class="col-md-4 col-md-offset-4">
           <h4>Register</h4><hr>
           <form action="{{ url('auth.save') }}" method="post">
           ...
           <div class="form-group">
              ...
              <div class="form-group">
                 ...
                 <input type="height" class="form-control" name="height" placeholder="Enter height">
                 <span class="text-danger">@error('height'){{ $message }} @enderror</span>
              </div>

              <div class="form-group">
                 <label>Weight in kg</label>
                 <input type="weight" class="form-control" name="weight" placeholder="Enter weight">
            ...
            <label>Gender</label>
              ...
              <a href="{{ url('auth.login') }}">I already have an account, Login</a>
           </form>
      </div>
   </div>
</div>
