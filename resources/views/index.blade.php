        ...
        <div class="container-fluid">
           <!--Row Start-->
            <div class="row">
                ...
                <h3>More than 500 Malaysian Food with Calories!<h3><br>
                <h3>“Healthy does NOT mean starving yourself EVER. Healthy means eating the right food in the right amount”. – Karen Salmansohn</span></h3>
                <a class="btn btn-success" href="{{url('auth.login')}}" role="button">Check Food Calories</a>
                </div>
            </div>
           <!--Row Ended-->
        </div>
...
<br>
<div class="column">
        <img src="assets/images/howitwork.png" alt="how"  style="width:100%">
</div>
<!-- <br>
<center><img src="assets/images/howitwork.png" alt="how" class="img"><center>
<br> -->
