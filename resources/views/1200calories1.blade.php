...
<img src="assets/images/1200calories1.png" alt="menu" class="img" style="width:50%;">
<br>
<div class="nextPreviousButtons">
<a href="{{url('1200calories')}}" class="previous">&laquo; Previous</a>
<a href="{{url('1200calories2')}}" class="next">Next Day2 &raquo;</a>
  </div>
