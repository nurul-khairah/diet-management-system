...
<img src="assets/images/2000calories2.png" alt="menu" class="img" style="width:50%;">
<br>
<div class="nextPreviousButtons">
<a href="{{url('2000calories1')}}" class="previous">&laquo; Previous Day1</a>
<a href="{{url('2000calories3')}}" class="next">Next Day3 &raquo;</a>
  </div>
