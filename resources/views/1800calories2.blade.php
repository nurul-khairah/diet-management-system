...
<img src="assets/images/1800calories2.png" alt="menu" class="img" style="width:50%;">
<br>
<div class="nextPreviousButtons">
<a href="{{url('1800calories1')}}" class="previous">&laquo; Previous Day1</a>
<a href="{{url('1800calories3')}}" class="next">Next Day3 &raquo;</a>
  </div>
