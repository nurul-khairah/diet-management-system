...
<img src="assets/images/2000calories1.png" alt="menu" class="img" style="width:50%;">
<br>
<div class="nextPreviousButtons">
<a href="{{url('2000calories')}}" class="previous">&laquo; Previous</a>
<a href="{{url('2000calories2')}}" class="next">Next Day2 &raquo;</a>
  </div>
