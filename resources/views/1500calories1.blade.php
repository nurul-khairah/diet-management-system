...
<img src="assets/images/1500calories1.png" alt="menu" class="img" style="width:50%;">
<br>
<div class="nextPreviousButtons">
<a href="{{url('1500calories')}}" class="previous">&laquo; Previous</a>
<a href="{{url('1500calories2')}}" class="next">Next Day2 &raquo;</a>
  </div>
